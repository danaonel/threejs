...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Cs(e,t,n){let r=new Float32Array(ls),i=new K(0,1,0);return new Ba({name:`SphericalGaussianBlur`,defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Es(),fragmentShader:`
	...
	`}var Ds=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ci([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
</div>`,xd=function(e,t){var n=e[t];return Q.isArray(arguments[2])||Q.isObject(arguments[2])?new od(e,t,arguments[2]):Q.isNumber(n)?Q.isNumber(arguments[2])&&Q.isNumber(arguments[3])?Q.isNumber(arguments[4])?new pd(e,t,arguments[2],arguments[3],arguments[4]):new pd(e,t,arguments[2],arguments[3]):Q.isNumber(arguments[4])?new dd(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new dd(e,t,{min:arguments[2],max:arguments[3]}):Q.isString(n)?new sd(e,t):Q.isFunction(n)?new md(e,t,``):Q.isBoolean(n)?new ad(e,t):null};function Sd(e){setTimeout(e,1e3/60)}var Cd=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Sd,wd=function(){function e(){Ku(this,e),this.backgroundElement=document.createElement(`div`),Q.extend(this.backgroundElement.style,{backgroundColor:`rgba(0,0,0,0.8)`,top:0,left:0,display:`none`,zIndex:`1000`,opacity:0,WebkitTransition:`opacity 0.2s linear`,transition:`opacity 0.2s linear`}),$.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position=`fixed`,this.domElement=document.createElement(`div`),Q.extend(this.domElement.style,{position:`fixed`,display:`none`,zIndex:`1001`,opacity:0,WebkitTransition:`-webkit-transform 0.2s ease-out, opacity 0.2s linear`,transition:`transform 0.2s ease-out, opacity 0.2s linear`}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var t=this;$.bind(this.backgroundElement,`click`,function(){t.hide()})}return qu(e,[{key:`show`,value:function(){var e=this;this.backgroundElement.style.display=`block`,this.domElement.style.display=`block`,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`,this.layout(),Q.defer(function(){e.backgroundElement.style.opacity=1,e.domElement.style.opacity=1,e.domElement.style.webkitTransform=`scale(1)`})}},{key:`hide`,value:function(){var e=this,t=function t(){e.domElement.style.display=`none`,e.backgroundElement.style.display=`none`,$.unbind(e.domElement,`webkitTransitionEnd`,t),$.unbind(e.domElement,`transitionend`,t),$.unbind(e.domElement,`oTransitionEnd`,t)};$.bind(this.domElement,`webkitTransitionEnd`,t),$.bind(this.domElement,`transitionend`,t),$.bind(this.domElement,`oTransitionEnd`,t),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`}},{key:`layout`,value:function(){this.domElement.style.left=window.innerWidth/2-$.getWidth(this.domElement)/2+`px`,this.domElement.style.top=window.innerHeight/2-$.getHeight(this.domElement)/2+`px`}}]),e}(),Td=Fu(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);yd.inject(Td);var Ed=`dg`,Dd=72,Od=20,kd=`Default`,Ad=function(){try{return!!window.localStorage}catch{return!1}}(),jd=void 0,Md=!0,Nd=void 0,Pd=!1,Fd=[],Id=function e(t){var n=this,r=t||{};this.domElement=document.createElement(`div`),this.__ul=document.createElement(`ul`),this.domElement.appendChild(this.__ul),$.addClass(this.domElement,Ed),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=Q.defaults(r,{closeOnTop:!1,autoPlace:!0,width:e.DEFAULT_WIDTH}),r=Q.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),Q.isUndefined(r.load)?r.load={preset:kd}:r.preset&&(r.load.preset=r.preset),Q.isUndefined(r.parent)&&r.hideable&&Fd.push(this),r.resizable=Q.isUndefined(r.parent)&&r.resizable,r.autoPlace&&Q.isUndefined(r.scrollable)&&(r.scrollable=!0);var i=Ad&&localStorage.getItem(Ud(this,`isLocal`))===`true`,a=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(e){n.parent?n.getRoot().preset=e:r.load.preset=e,Xd(this),n.revert()}},width:{get:function(){return r.width},set:function(e){r.width=e,Jd(n,e)}},name:{get:function(){return r.name},set:function(e){r.name=e,o&&(o.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(t){r.closed=t,r.closed?$.addClass(n.__ul,e.CLASS_CLOSED):$.removeClass(n.__ul,e.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=t?e.TEXT_OPEN:e.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return i},set:function(e){Ad&&(i=e,e?$.bind(window,`unload`,a):$.unbind(window,`unload`,a),localStorage.setItem(Ud(n,`isLocal`),e))}}}),Q.isUndefined(r.parent)){if(this.closed=r.closed||!1,$.addClass(this.domElement,e.CLASS_MAIN),$.makeSelectable(this.domElement,!1),Ad&&i){n.useLocalStorage=!0;var s=localStorage.getItem(Ud(this,`gui`));s&&(r.load=JSON.parse(s))}this.__closeButton=document.createElement(`div`),this.__closeButton.innerHTML=e.TEXT_CLOSED,$.addClass(this.__closeButton,e.CLASS_CLOSE_BUTTON),r.closeOnTop?($.addClass(this.__closeButton,e.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):($.addClass(this.__closeButton,e.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),$.bind(this.__closeButton,`click`,function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var c=document.createTextNode(r.name);$.addClass(c,`controller-name`),o=Ld(n,c),$.addClass(this.__ul,e.CLASS_CLOSED),$.addClass(o,`title`),$.bind(o,`click`,function(e){return e.preventDefault(),n.closed=!n.closed,!1}),r.closed||(this.closed=!1)}r.autoPlace&&(Q.isUndefined(r.parent)&&(Md&&=(Nd=document.createElement(`div`),$.addClass(Nd,Ed),$.addClass(Nd,e.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(Nd),!1),Nd.appendChild(this.domElement),$.addClass(this.domElement,e.CLASS_AUTO_PLACE)),this.parent||Jd(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},$.bind(window,`resize`,this.__resizeHandler),$.bind(this.__ul,`webkitTransitionEnd`,this.__resizeHandler),$.bind(this.__ul,`transitionend`,this.__resizeHandler),$.bind(this.__ul,`oTransitionEnd`,this.__resizeHandler),this.onResize(),r.resizable&&qd(this),a=function(){Ad&&localStorage.getItem(Ud(n,`isLocal`))===`true`&&localStorage.setItem(Ud(n,`gui`),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=a;function l(){var e=n.getRoot();e.width+=1,Q.defer(function(){--e.width})}r.parent||l()};Id.toggleHide=function(){Pd=!Pd,Q.each(Fd,function(e){e.domElement.style.display=Pd?`none`:``})},Id.CLASS_AUTO_PLACE=`a`,Id.CLASS_AUTO_PLACE_CONTAINER=`ac`,Id.CLASS_MAIN=`main`,Id.CLASS_CONTROLLER_ROW=`cr`,Id.CLASS_TOO_TALL=`taller-than-window`,Id.CLASS_CLOSED=`closed`,Id.CLASS_CLOSE_BUTTON=`close-button`,Id.CLASS_CLOSE_TOP=`close-top`,Id.CLASS_CLOSE_BOTTOM=`close-bottom`,Id.CLASS_DRAG=`drag`,Id.DEFAULT_WIDTH=245,Id.TEXT_CLOSED=`Close Controls`,Id.TEXT_OPEN=`Open Controls`,Id._keydownHandler=function(e){document.activeElement.type!==`text`&&(e.which===Dd||e.keyCode===Dd)&&Id.toggleHide()},$.bind(window,`keydown`,Id._keydownHandler,!1),Q.extend(Id.prototype,{add:function(e,t){return Hd(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return Hd(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;Q.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw Error(`Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.`);this.autoPlace&&Nd.removeChild(this.domElement);var e=this;Q.each(this.__folders,function(t){e.removeFolder(t)}),$.unbind(window,`keydown`,Id._keydownHandler,!1),Rd(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw Error(`You already have a folder in this GUI by the name "`+e+`"`);var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new Id(t);this.__folders[e]=n;var r=Ld(this,n.domElement);return $.addClass(r,`folder`),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Rd(e);var t=this;Q.each(e.__folders,function(t){e.removeFolder(t)}),Q.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display=`none`},show:function(){this.domElement.style.display=``},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=$.getOffset(e.__ul).top,n=0;Q.each(e.__ul.childNodes,function(t){e.autoPlace&&t===e.__save_row||(n+=$.getHeight(t))}),window.innerHeight-t-Od<n?($.addClass(e.domElement,Id.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-Od+`px`):($.removeClass(e.domElement,Id.CLASS_TOO_TALL),e.__ul.style.height=`auto`)}e.__resize_handle&&Q.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+`px`}),e.__closeButton&&(e.__closeButton.style.width=e.width+`px`)},onResizeDebounced:Q.debounce(function(){this.onResize()},50),remember:function(){if(Q.isUndefined(jd)&&(jd=new wd,jd.domElement.innerHTML=bd),this.parent)throw Error(`You can only call remember on a top level GUI.`);var e=this;Q.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&Kd(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&Jd(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||={},e.remembered[this.preset]=Yd(this)),e.folders={},Q.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=Yd(this),zd(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[kd]=Yd(this,!0)),this.load.remembered[e]=Yd(this),this.preset=e,Wd(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){Q.each(this.__controllers,function(t){this.getRoot().load.remembered?Vd(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),Q.each(this.__folders,function(e){e.revert(e)}),e||zd(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&Zd(this.__listening)},updateDisplay:function(){Q.each(this.__controllers,function(e){e.updateDisplay()}),Q.each(this.__folders,function(e){e.updateDisplay()})}});function Ld(e,t,n){var r=document.createElement(`li`);return t&&r.appendChild(t),n?e.__ul.insertBefore(r,n):e.__ul.appendChild(r),e.onResize(),r}function Rd(e){$.unbind(window,`resize`,e.__resizeHandler),e.saveToLocalStorageIfPossible&&$.unbind(window,`unload`,e.saveToLocalStorageIfPossible)}function zd(e,t){var n=e.__preset_select[e.__preset_select.selectedIndex];t?n.innerHTML=n.value+`*`:n.innerHTML=n.value}function Bd(e,t,n){if(n.__li=t,n.__gui=e,Q.extend(n,{options:function(t){if(arguments.length>1){var r=n.__li.nextElementSibling;return n.remove(),Hd(e,n.object,n.property,{before:r,factoryArgs:[Q.toArray(arguments)]})}if(Q.isArray(t)||Q.isObject(t)){var i=n.__li.nextElementSibling;return n.remove(),Hd(e,n.object,n.property,{before:i,factoryArgs:[t]})}},name:function(e){return n.__li.firstElementChild.firstElementChild.innerHTML=e,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof pd){var r=new dd(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});Q.each([`updateDisplay`,`onChange`,`onFinishChange`,`step`,`min`,`max`],function(e){var t=n[e],i=r[e];n[e]=r[e]=function(){var e=Array.prototype.slice.call(arguments);return i.apply(r,e),t.apply(n,e)}}),$.addClass(t,`has-slider`),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof dd){var i=function(t){if(Q.isNumber(n.__min)&&Q.isNumber(n.__max)){var r=n.__li.firstElementChild.firstElementChild.innerHTML,i=n.__gui.__listening.indexOf(n)>-1;n.remove();var a=Hd(e,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return a.name(r),i&&a.listen(),a}return t};n.min=Q.compose(i,n.min),n.max=Q.compose(i,n.max)}else n instanceof ad?($.bind(t,`click`,function(){$.fakeEvent(n.__checkbox,`click`)}),$.bind(n.__checkbox,`click`,function(e){e.stopPropagation()})):n instanceof md?($.bind(t,`click`,function(){$.fakeEvent(n.__button,`click`)}),$.bind(t,`mouseover`,function(){$.addClass(n.__button,`hover`)}),$.bind(t,`mouseout`,function(){$.removeClass(n.__button,`hover`)})):n instanceof hd&&($.addClass(t,`color`),n.updateDisplay=Q.compose(function(e){return t.style.borderLeftColor=n.__color.toString(),e},n.updateDisplay),n.updateDisplay());n.setValue=Q.compose(function(t){return e.getRoot().__preset_select&&n.isModified()&&zd(e.getRoot(),!0),t},n.setValue)}function Vd(e,t){var n=e.getRoot(),r=n.__rememberedObjects.indexOf(t.object);if(r!==-1){var i=n.__rememberedObjectIndecesToControllers[r];if(i===void 0&&(i={},n.__rememberedObjectIndecesToControllers[r]=i),i[t.property]=t,n.load&&n.load.remembered){var a=n.load.remembered,o=void 0;if(a[e.preset])o=a[e.preset];else if(a[kd])o=a[kd];else return;if(o[r]&&o[r][t.property]!==void 0){var s=o[r][t.property];t.initialValue=s,t.setValue(s)}}}}function Hd(e,t,n,r){if(t[n]===void 0)throw Error(`Object "`+t+`" has no property "`+n+`"`);var i=void 0;if(r.color)i=new hd(t,n);else{var a=[t,n].concat(r.factoryArgs);i=xd.apply(e,a)}r.before instanceof ed&&(r.before=r.before.__li),Vd(e,i),$.addClass(i.domElement,`c`);var o=document.createElement(`span`);$.addClass(o,`property-name`),o.innerHTML=i.property;var s=document.createElement(`div`);s.appendChild(o),s.appendChild(i.domElement);var c=Ld(e,s,r.before);return $.addClass(c,Id.CLASS_CONTROLLER_ROW),i instanceof hd?$.addClass(c,`color`):$.addClass(c,Gu(i.getValue())),Bd(e,c,i),e.__controllers.push(i),i}function Ud(e,t){return document.location.href+`.`+t}function Wd(e,t,n){var r=document.createElement(`option`);r.innerHTML=t,r.value=t,e.__preset_select.appendChild(r),n&&(e.__preset_select.selectedIndex=e.__preset_select.length-1)}function Gd(e,t){t.style.display=e.useLocalStorage?`block`:`none`}function Kd(e){var t=e.__save_row=document.createElement(`li`);$.addClass(e.domElement,`has-save`),e.__ul.insertBefore(t,e.__ul.firstChild),$.addClass(t,`save-row`);var n=document.createElement(`span`);n.innerHTML=`&nbsp;`,$.addClass(n,`button gears`);var r=document.createElement(`span`);r.innerHTML=`Save`,$.addClass(r,`button`),$.addClass(r,`save`);var i=document.createElement(`span`);i.innerHTML=`New`,$.addClass(i,`button`),$.addClass(i,`save-as`);var a=document.createElement(`span`);a.innerHTML=`Revert`,$.addClass(a,`button`),$.addClass(a,`revert`);var o=e.__preset_select=document.createElement(`select`);if(e.load&&e.load.remembered?Q.each(e.load.remembered,function(t,n){Wd(e,n,n===e.preset)}):Wd(e,kd,!1),$.bind(o,`change`,function(){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].innerHTML=e.__preset_select[t].value;e.preset=this.value}),t.appendChild(o),t.appendChild(n),t.appendChild(r),t.appendChild(i),t.appendChild(a),Ad){var s=document.getElementById(`dg-local-explain`),c=document.getElementById(`dg-local-storage`),l=document.getElementById(`dg-save-locally`);l.style.display=`block`,localStorage.getItem(Ud(e,`isLocal`))===`true`&&c.setAttribute(`checked`,`checked`),Gd(e,s),$.bind(c,`change`,function(){e.useLocalStorage=!e.useLocalStorage,Gd(e,s)})}var u=document.getElementById(`dg-new-constructor`);$.bind(u,`keydown`,function(e){e.metaKey&&(e.which===67||e.keyCode===67)&&jd.hide()}),$.bind(n,`click`,function(){u.innerHTML=JSON.stringify(e.getSaveObject(),void 0,2),jd.show(),u.focus(),u.select()}),$.bind(r,`click`,function(){e.save()}),$.bind(i,`click`,function(){var t=prompt(`Enter a new preset name.`);t&&e.saveAs(t)}),$.bind(a,`click`,function(){e.revert()})}function qd(e){var t=void 0;e.__resize_handle=document.createElement(`div`),Q.extend(e.__resize_handle.style,{width:`6px`,marginLeft:`-3px`,height:`200px`,cursor:`ew-resize`,position:`absolute`});function n(n){return n.preventDefault(),e.width+=t-n.clientX,e.onResize(),t=n.clientX,!1}function r(){$.removeClass(e.__closeButton,Id.CLASS_DRAG),$.unbind(window,`mousemove`,n),$.unbind(window,`mouseup`,r)}function i(i){return i.preventDefault(),t=i.clientX,$.addClass(e.__closeButton,Id.CLASS_DRAG),$.bind(window,`mousemove`,n),$.bind(window,`mouseup`,r),!1}$.bind(e.__resize_handle,`mousedown`,i),$.bind(e.__closeButton,`mousedown`,i),e.domElement.insertBefore(e.__resize_handle,e.domElement.firstElementChild)}function Jd(e,t){e.domElement.style.width=t+`px`,e.__save_row&&e.autoPlace&&(e.__save_row.style.width=t+`px`),e.__closeButton&&(e.__closeButton.style.width=t+`px`)}function Yd(e,t){var n={};return Q.each(e.__rememberedObjects,function(r,i){var a={},o=e.__rememberedObjectIndecesToControllers[i];Q.each(o,function(e,n){a[n]=t?e.initialValue:e.getValue()}),n[i]=a}),n}function Xd(e){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].value===e.preset&&(e.__preset_select.selectedIndex=t)}function Zd(e){e.length!==0&&Cd.call(window,function(){Zd(e)}),Q.each(e,function(e){e.updateDisplay()})}var Qd=Id,$d=new Nn;$d.background=new Y(8900331),$d.fog=new Mn(8900331,30,80);var ef=new To(60,window.innerWidth/window.innerHeight,.1,1e3);ef.position.set(8,5,12);var tf=new uu({antialias:!0});tf.setSize(window.innerWidth,window.innerHeight),tf.shadowMap.enabled=!0,tf.shadowMap.type=2,document.body.appendChild(tf.domElement);var nf=new xu(ef,tf.domElement);nf.enableDamping=!0,nf.target.set(0,2,0);var rf=new ko(16777215,.5);$d.add(rf);var af=new Oo(16776160,1.5);af.position.set(12,18,10),af.castShadow=!0,af.shadow.mapSize.set(2048,2048),af.shadow.camera.near=.5,af.shadow.camera.far=60,af.shadow.camera.left=-15,af.shadow.camera.right=15,af.shadow.camera.top=15,af.shadow.camera.bottom=-15,$d.add(af);var of=new Xr(new Aa(40,40),new Ha({color:4881502}));of.rotation.x=-Math.PI/2,of.receiveShadow=!0,$d.add(of);var sf=5,cf=3.5,lf=6,uf=new fi(sf,cf,lf),df=new Ha({color:16113331}),ff=new Xr(uf,df);ff.position.y=cf/2,ff.castShadow=!0,ff.receiveShadow=!0,$d.add(ff);var pf=new Xr(new fi(.9,1.8,.05),new Ha({color:6044190}));pf.position.set(0,.9,lf/2+.01),$d.add(pf);var mf=.4,hf=.3,gf=2.5,_f=sf/2+mf,vf=lf+hf*2,yf=new Ui;yf.moveTo(-_f,0),yf.lineTo(_f,0),yf.lineTo(0,gf),yf.closePath();var bf=new Da(yf,{depth:vf,bevelEnabled:!1});bf.translate(0,0,-vf/2);var xf={shinglesA:`pewter-gray-gaf-roof-shingles-0487552-64_600.jpg`,shinglesB:`Vinyl-Round-Shingles-87924804.jpg`,shinglesC:`antique-slate-gaf-roof-shingles-0711014-64_600.jpg`},Sf=new fo,Cf=new Map,wf=new Map;function Tf(e){let t=Cf.get(e);return t||(t=Sf.load(`./img/${encodeURIComponent(e)}`),t.wrapS=n,t.wrapT=n,t.repeat.set(.5,.5),t.center.set(.5,.5),t.rotation=0*Math.PI,Cf.set(e,t)),t}function Ef(e){let t=wf.get(e);return t||(t=Sf.load(`./img/${encodeURIComponent(e)}`),t.wrapS=n,t.wrapT=n,t.repeat.set(.5,.5),t.center.set(.5,.5),t.rotation=Math.PI/2,wf.set(e,t)),t}var Df=new Ha({map:Tf(xf.shinglesA)}),Of=new Ha({map:Ef(xf.shinglesA)}),kf=new Xr(bf,[Df,Of,Of]);kf.position.set(0,cf,0),kf.castShadow=!0,kf.receiveShadow=!0,$d.add(kf);var Af=new Ui;Af.moveTo(-sf/2,0),Af.lineTo(sf/2,0),Af.lineTo(0,gf),Af.closePath();var jf=new ja(Af),Mf=new Xr(jf,df);Mf.position.set(0,cf,lf/2+.002),Mf.castShadow=!0,Mf.receiveShadow=!0,$d.add(Mf);var Nf=new Xr(jf,df);Nf.position.set(0,cf,-(lf/2+.002)),Nf.rotation.y=Math.PI,Nf.castShadow=!0,Nf.receiveShadow=!0,$d.add(Nf);var Pf=new Xr(new pi(.05,.05,vf,8),new Ha({color:5904922}));Pf.rotation.x=Math.PI/2,Pf.position.set(0,cf+gf,0),$d.add(Pf),window.addEventListener(`resize`,()=>{ef.aspect=window.innerWidth/window.innerHeight,ef.updateProjectionMatrix(),tf.setSize(window.innerWidth,window.innerHeight)});var Ff=new Pu;document.body.appendChild(Ff.dom);var If=new Qd,Lf=If.addFolder(`Roof`),Rf={};for(let[e,t]of Object.entries(xf))Rf[e]=()=>{Df.map=Tf(t),Df.needsUpdate=!0,Of.map=Ef(t),Of.needsUpdate=!0},Lf.add(Rf,e);Lf.add(Df,`wireframe`),Lf.open();var zf=If.addFolder(`Walls`);zf.addColor({color:16113331},`color`).onChange(e=>df.setValues({color:e})).name(`color`),zf.add(df,`wireframe`),zf.open();function Bf(){requestAnimationFrame(Bf),nf.update(),tf.render($d,ef),Ff.update()}Bf();